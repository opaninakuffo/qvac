 ...
 * PRs use markdown-bold labels (`**BEFORE:**` / `**AFTER:**`) followed by
 * fenced code blocks. The legacy regex stopped AFTER at the first blank line
 * after the label, which is always present before the code block.
 * @param {string} text
 * @returns {string|null}
 */
